...
RUN groupadd -g 1000 prueba1Back && \
	useradd -ms /bin/bash -u 1000 -g 1000 prueba1Back && \
	mkdir -p /app && \
	chown prueba1Back:prueba1Back /app
...
COPY --chown=prueba1Back:prueba1Back package.json .
COPY --chown=prueba1Back:prueba1Back yarn.lock .

RUN yarn install --frozen-lockfile && yarn cache clean

COPY --chown=prueba1Back:prueba1Back src src/
